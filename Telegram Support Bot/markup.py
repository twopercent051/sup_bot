...
def markup_confirm_req(req_id, is_agent):

    markup_confirm_req = types.InlineKeyboardMarkup(row_width=1)
    item1 = types.InlineKeyboardButton("✅ Подтвердить", callback_data=f'confirm_req:true:{req_id}:{is_agent}')
...
def markup_sources():
    markup_sources = types.InlineKeyboardMarkup(row_width=3)
    item1 = types.InlineKeyboardButton("1", callback_data='source_1')
    item2 = types.InlineKeyboardButton("2", callback_data='source_2')
    item3 = types.InlineKeyboardButton("3", callback_data='source_3')
    item4 = types.InlineKeyboardButton("4", callback_data='source_4')
    item5 = types.InlineKeyboardButton("5", callback_data='source_5')
    item6 = types.InlineKeyboardButton("6", callback_data='source_6')
    markup_sources.add(item1, item2, item3, item4, item5, item6)

    return markup_sources